      ...
      <main className="bg-black text-white pt-16">
        ...
        <section className="py-16 bg-gradient-to-b from-gray-900 to-black">
          <div className="container mx-auto px-6 md:px-12 text-gray-300 space-y-8">
            ...
            <div>
              <p className="text-sm">
                <strong>Last updated:</strong> October 27, 2022
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 mt-2">
                ...
                <li>
                  <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Linconwaves Innovation Ltd, 20 22 Wenlock Rd, London N1 7TA GB.
                </li>
                <li>
                ...
                <li>
                  <strong>Website</strong> refers to linconwaves innovation, accessible from https://www.linconwavesinnovation.com
                </li>
                <li>
            ...
            <div>
              ...
              {/* For brevity, I'll include the remaining sections similarly structured */}

              {/* Tracking Technologies and Cookies */}
              <div>
                <h3 className="text-2xl font-semibold mt-6 mb-2">Tracking Technologies and Cookies</h3>
                <p>
                ...
                {/* Subsections for Cookies */}
                <div className="mt-4">
                  <h4 className="text-xl font-semibold mb-2">Necessary / Essential Cookies</h4>
                  <p>
                ...
                <div className="mt-6">
                  <h4 className="text-xl font-semibold mb-2">Cookies Policy / Notice Acceptance Cookies</h4>
                  <p>
                ...
                <div className="mt-6">
                  <h4 className="text-xl font-semibold mb-2">Functionality Cookies</h4>
                  <p>
                    <strong>Type:</strong> Persistent Cookies
                  </p>
                  <p>
              ...
              <div>
                <h2 className="text-3xl font-bold mb-4">Retention of Your Personal Data</h2>
                <p>
              ...
              <div>
                ...
                <div className="mt-6">
                  <h3 className="text-2xl font-semibold mb-2">Business Transactions</h3>
                  <p>
                ...
                {/* Law enforcement */}
                <div className="mt-6">
                  <h3 className="text-2xl font-semibold mb-2">Law enforcement</h3>
                  <p>
                ...
                <div className="mt-6">
                  <h3 className="text-2xl font-semibold mb-2">Other legal requirements</h3>
                  <p>
